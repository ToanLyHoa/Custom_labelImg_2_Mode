...
class Canvas(QWidget):
    ...
    def set_last_label(self, text, staff_security, gender, age, QA, line_color=None, fill_color=None):
        assert text
        self.shapes[-1].label = text
        self.shapes[-1].staff_security = staff_security
        self.shapes[-1].gender = gender
        self.shapes[-1].age = age
        self.shapes[-1].QA = QA
        if line_color:
