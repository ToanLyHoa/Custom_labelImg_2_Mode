...
class Shape(object):
    ...
    def __init__(self, label=None, line_color=None, difficult=False, paint_label=False,
                        gender = None, age = None, QA = None, staff_security = None):
        self.label = label
        # Thinkman edit here
        self.staff_security = staff_security
        self.gender = gender
        self.age = age
        self.QA = QA
    ...
    def get_string(self):
        return f"{self.staff_security}\n-{self.gender}-{self.age}\n-{self.QA}"
    
    def get_string_staff_security(self):
        return f"{self.staff_security}"
    def get_string_gender_age(self):
        return f"{self.gender}-{self.age}"
    def get_string_QA(self):
        return f"{self.QA}"
        ...
        if self.points:
            ...
            if self.paint_label:
                ...
                if min_x != sys.maxsize and min_y != sys.maxsize:
                    ...
                    # vẽ thêm thông tin nè

                    # chỉnh màu cho phần chữ
                    if self.selected:
                    ...
                    painter.drawText(int(min_x), int(min_y) - 40, 
                                    self.get_string_staff_security())
                    painter.drawText(int(min_x), int(min_y) - 20, 
                                    self.get_string_gender_age())
                    painter.drawText(int(min_x), int(min_y), 
                                    self.get_string_QA())
                    # painter.drawText(int(min_x), int(min_y), 
                    #                 self.get_string_QA())
